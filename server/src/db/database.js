...
exports.findAllInstances = exports.dropDatabase = exports.isDatabaseInitialized = exports.initDatabase = exports.dataTypes = exports.sequelize = void 0;
...
function dropDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.sequelize.drop()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function findAllInstances(model) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, model.findAll()];
        });
    });
}
exports.findAllInstances = findAllInstances;
