...
function CreateDoctor({ refetchDoctors }) {
  ...
  const openModal = (message, isError) => {
    AntModal[isError ? "error" : "success"]({
      content: <p>{message}</p>,
      okText: t("Physicians.close_button"),
      centered: true,
      onOk: () => {
        if (!isError) {
      ...
      <Col span={16}>
        <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                label={t("Physicians.first_name_label")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.required_first_name_error"),
                    minLength: {
                      value: 2,
                      message: t("Physicians.first_name_min_length_error"),
                    },
                  }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      placeholder={t("Physicians.enter_first_name_placeholder")}
                    />
                  )}
                />
              </Form.Item>
            ...
            <Col span={12}>
              <Form.Item
                label={t("Physicians.last_name_label")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.required_last_name_error"),
                    minLength: {
                      value: 2,
                      message: t("Physicians.last_name_min_length_error"),
                    },
                  }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      placeholder={t("Physicians.enter_last_name_placeholder")}
                    />
                  )}
                />
              </Form.Item>
          ...
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.required_email_error"),
                    pattern: {
                      value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                      message: t("Physicians.invalid_email_format_error"),
                    },
                  }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      placeholder={t("Physicians.enter_email_placeholder")}
                    />
                  )}
                />
              </Form.Item>
            ...
            <Col span={12}>
              <Form.Item
                label={t("Physicians.confirm_email_label")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.required_email_confirmation_error"),
                    validate: (value) =>
                      value === control._formValues.email ||
                      t("Physicians.email_mismatch_error"),
                  }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      placeholder={t("Physicians.confirm_email_placeholder")}
                    />
                  )}
                />
              </Form.Item>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                label={t("Physicians.phone_number")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.required_phone_number_error"),
                    pattern: {
                      value: /^[0-9+\s-]{8,}$/,
                      message: t("Physicians.invalid_phone_number_error"),
                    },
                  }}
                  render={({ field }) => (
                    <Input
                      {...field}
                      placeholder={t("Physicians.phone_number_placeholder")}
                    />
                  )}
                />
              </Form.Item>
            ...
            <Col span={12}>
              <Form.Item
                label={t("Physicians.work_environment_label")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("Physicians.work_environment_required"),
                    minLength: {
                      value: 2,
                      message: t("Physicians.work_environment_min_length"),
                    },
                  }}
                  render={({ field }) => (
                    <Select
                      {...field}
                      placeholder={t("Physicians.work_environment_placeholder")}
                    >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                label={t("Physicians.password_label")}
                required
              ...
              >
                <Input.Group compact>
                  <Controller
                    ...
                    control={control}
                    rules={{
                      required: t("Physicians.required_password_error"),
                      minLength: {
                        value: 8,
                        message: t("Physicians.password_min_length_error"),
                      },
                      pattern: {
                        value: /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/,
                        message: t("Physicians.password_requirements_error"),
                      },
                    }}
                    render={({ field }) => (
                      <>
                        <Input.Password
                          {...field}
                          placeholder={t("Physicians.password_placeholder")}
                          style={{ width: "calc(100% - 40px)" }}
                        />
                        <Tooltip
                          title={t("Physicians.generate_password_tooltip")}
                        >
                          <Button
                            icon={<KeyOutlined />}
          ...
          <Form.Item className="submit-button">
            <Button type="primary" htmlType="submit" icon={<SendOutlined />}>
              {t("Physicians.create_physician_button")}
            </Button>
          </Form.Item>
        </Form>
      </Col>
