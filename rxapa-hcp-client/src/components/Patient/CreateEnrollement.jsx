    ...
    <Row justify="center">
      <Col span={16}>
        <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
          ...
          <h2>{t("program_enrollment")}</h2>
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item
                label={t("program_select")}
                required
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("program_select_required"),
                  }}
                  render={({ field }) => (
                    <Select
                      {...field}
                      placeholder={t("program_select")}
                      style={{ width: "100%" }}
                    >
            ...
            <Col span={8}>
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("program_code_required"),
                  }}
                  render={({ field }) => (
                    <Input {...field} placeholder={t("program_code_input")} />
                  )}
                />
              </Form.Item>
            </Col>
            ...
            <Col span={8}>
              ...
              >
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: t("program_duration_required"),
                  }}
                  render={({ field }) => (
                    <RangePicker
                      {...field}
                      style={{ width: "100%" }}
                      format="YYYY-MM-DD"
                      placeholder={[t("date_start"), t("date_end")]}
                    />
                  )}
                />
              </Form.Item>
